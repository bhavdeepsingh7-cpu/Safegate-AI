...
The repository contains sample evidence snapshots. They are evidence images rather than dashboard screenshots:

![Example access-denied evidence snapshot](logs/snapshots/2026-07-28/access_denied/17-16-15_1002_john_smith.jpg)

No dedicated screenshots of the dashboard, live-camera screen or hardware prototype are stored in `docs/images/`.
